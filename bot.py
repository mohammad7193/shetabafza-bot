...
def generate_post_content():
    ...
    یک پست جذاب در مورد ترفندهای رشد کسب‌وکار بنویس.
    
    خروجی دقیقاً با این فرمت:
    متن: [کپشن حرفه‌ای با پاراگراف‌های کوتاه و ایموجی. بدون استفاده از تگ‌های HTML یا ستاره. فقط متن خالص با فاصله‌گذاری مناسب باشد تا در همه پلتفرم‌ها (اینستاگرام، بله، تلگرام) بدون ارور نمایش داده شود.]
    موضوع_تصویر: [یک عبارت انگلیسی برای جستجوی عکس مثل: digital marketing, startup growth]
    """
